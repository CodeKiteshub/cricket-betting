...
import 'package:cricket_betting/bloc/teamSelectionBloc.dart';
import 'package:cricket_betting/bloc/teamTapBloc.dart';
...
import 'package:cricket_betting/models/squadsResponseData.dart';
import 'package:cricket_betting/modules/createTeam/chooseCVCScreen.dart';
import 'package:cricket_betting/modules/createTeam/createTeamProgressbar.dart';
import 'package:cricket_betting/modules/createTeam/playerProfile.dart';
import 'package:cricket_betting/modules/createTeam/teamPreview.dart';
import 'package:cricket_betting/utils/avatarImage.dart';
import 'package:cricket_betting/models/teamResponseData.dart' as team;
...
class TeamSelectionList extends StatefulWidget {
  ...
  const TeamSelectionList(
      {Key? key, this.players, this.tabType, this.shedualData})
      : super(key: key);
  @override
...
class PlayerslistUI extends StatelessWidget {
  ...
  const PlayerslistUI(
      {Key? key, required this.player, required this.shedualData})
      : super(key: key);
